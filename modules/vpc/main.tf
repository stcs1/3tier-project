...
resource "aws_subnet" "public_subnet_az1" {
  vpc_id                  = var.aws_vpc.vpc.vpc_id
  cidr_block              = var.public_subnet_az1_cidr
  availability_zone       = var.aws_availability_zones.Names[o]
...
resource "aws_subnet" "private_app_subnet_az1" {
  vpc_id                   = var.aws_vpc.vpc.id
  cidr_block               = var.private_app_subnet_az1.id
  availability_zone        = var.aws_availability_zones.Names[o]
...
resource "aws_subnet" "private_app_subnet_az2" {
  vpc_id                   = var.aws_vpc.vpc.id
  cidr_block               = var.private_app_subnet_az2.id
  availability_zone        =  var.aws_availability_zones.Names[1]
  map_public_ip_on_launch  =  false
...
resource "aws_subnet" "private_data_subnet_az1" {
  vpc_id                   = var.aws_vpc.vpc.id
  cidr_block               = var.private_data_subnet_az1.id
...
resource "aws_subnet" "private_data_subnet_az2" {
  vpc_id                   = var.aws_vpc.vpc.id
  cidr_block               = var.private_data_subnet_az2.id
  availability_zone        = var.aws_availability_zones.Names[1]
  map_public_ip_on_launch  = false
